...
plt.plot(np.linspace(0, max_x, Nx), np.sqrt(np.linspace(0, max_x, Nx)), color="k")

plt.plot(np.linspace(0, max_x, Nx), np.linspace(0, 0, Nx), color="k")

plt.plot(np.linspace(max_x, max_x, Nx), np.linspace(0, math.sqrt(max_x), Nx), color="k")
